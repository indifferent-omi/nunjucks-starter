...
const destination = (argv.clean) ? 'Developed/demo/' : (argv.pub) ? 'Developed/publish/' : 'Developed/development/';
...
// Builds
    ...
    // const copy = gulp.series(fonts,php,plugins,javascript,sass,imgmin);
